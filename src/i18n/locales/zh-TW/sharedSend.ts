...
const sharedSend = {
  sharedSend: {
    ...
    cancel: "取消",
    providerRetryPillOn: "重試 {{count}}次",
    providerRetryPillOff: "重試 關",
    providerRetryTitle: "供應商失敗自動重試",
    providerRetryScope: "目前 CLI：{{cli}}。只對這個共用會話的 {{cli}} 生效，重新整理後回到預設。",
    providerRetryEnabled: "自動再試",
    providerRetryMax: "次數",
    providerRetryBackoff: "退避",
    providerRetryBackoffExp: "指數 ×2",
    providerRetryBackoffFixed: "固定",
    providerRetryBase: "第一次等（秒）",
    providerRetryCap: "最長再等（秒）",
    providerRetryUnit: "秒",
    providerRetryDelayHint: "第一次失敗後先等這麼多秒再發；之後按退避加倍，但不會超過最長再等。",
    providerRetryPrompt: "發給 CLI 的續跑指令",
    providerRetryWait: "{{cli}} 暫時失敗（{{reason}}）· {{seconds}}s 後再試 {{n}}/{{max}}",
    providerRetrySending: "正在發給 {{cli}} · {{n}}/{{max}}",
    providerRetryExhausted: "{{cli}} 已重試 {{n}} 次仍失敗",
    providerRetryPermanent: "{{reason}}，不自動再發",
    providerRetryStopped: "已停止後續自動重試",
    providerRetrySuccess: "第 {{n}} 次已接通",
    providerRetryNow: "立即",
    providerRetryStop: "停止",
    providerRetryAgain: "再試",
    providerRetryAutoMark: "第 {{n}} 次自動續跑 · {{date}}",
    providerRetryReasonPool: "號池",
    providerRetryReasonRate: "請求過多",
    providerRetryReasonTimeout: "超時",
    providerRetryReasonOverload: "過載",
    providerRetryReasonServer: "服務錯誤",
    providerRetryReasonSoftCancel: "暫時中斷",
    providerRetryReasonConfig: "設定錯誤",
    providerRetryReasonOverflow: "上下文過長",
    providerRetryReasonQuota: "配額不足",
    providerRetryReasonPermission: "權限拒絕",
    providerRetryReasonStopped: "已停止",
    providerRetryReasonUnknown: "暫時失敗",
  },
};
